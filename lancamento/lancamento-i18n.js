(() => {
  const copy = {
    en: {
      ...
      "R$ 200 OFF - MAIS VANTAJOSO": "R$ 200 OFF - BEST VALUE",
      "MAIS FLEXÍVEL": "MORE FLEXIBLE",
      "Melhor custo-benefício": "Best value",
      "Sem compromisso anual": "No annual commitment",
      "por apenas": "only",
      "Acesso completo durante 1 ano": "Full access for one year",
      "Todas as ferramentas e atualizações do DocFlow ARQ": "All DocFlow ARQ tools and updates",
      "Até 2 usuários ativos por licença": "Up to 2 active users per license",
      ...
      "Quero o plano anual — 12x de R$ 79": "I want the annual plan — 12 installments of R$ 79",
      ...
      "No plano anual, você paga 12x de R$ 79 e economiza R$ 200 em comparação com 12 meses no plano mensal. No plano mensal, você paga R$ 99 por mês, sem compromisso, e pode cancelar quando quiser.": "On the annual plan, you pay 12 installments of R$ 79 and save R$ 200 compared with 12 months on the monthly plan. On the monthly plan, you pay R$ 99 per month with no commitment and can cancel anytime.",
    ...
    es: {
      ...
      "R$ 200 OFF - MAIS VANTAJOSO": "R$ 200 OFF - MÁS CONVENIENTE",
      "MAIS FLEXÍVEL": "MÁS FLEXIBLE",
      "Melhor custo-benefício": "Mejor relación calidad-precio",
      "Sem compromisso anual": "Sin compromiso anual",
      "por apenas": "por solo",
      "Acesso completo durante 1 ano": "Acceso completo durante un año",
      "Todas as ferramentas e atualizações do DocFlow ARQ": "Todas las herramientas y actualizaciones de DocFlow ARQ",
      "Até 2 usuários ativos por licença": "Hasta 2 usuarios activos por licencia",
      ...
      "Quero o plano anual — 12x de R$ 79": "Quiero el plan anual — 12 cuotas de R$ 79",
      ...
      "No plano anual, você paga 12x de R$ 79 e economiza R$ 200 em comparação com 12 meses no plano mensal. No plano mensal, você paga R$ 99 por mês, sem compromisso, e pode cancelar quando quiser.": "En el plan anual, paga 12 cuotas de R$ 79 y ahorra R$ 200 frente a 12 meses del plan mensual. En el plan mensual, paga R$ 99 al mes, sin compromiso, y puede cancelar cuando quiera.",
